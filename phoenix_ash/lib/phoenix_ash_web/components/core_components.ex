defmodule PhoenixAshWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(PhoenixAshWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(PhoenixAshWeb.Gettext, "errors", msg, opts)
    end
  end
